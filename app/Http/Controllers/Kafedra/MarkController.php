...
class MarkController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kafedraboshligi.layouts.mark.index', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kafedraboshligi.markgroup',  ['task_id'=> $request->task_id, 'fan_id'=>$request->fan_id, 'group_id'=>$request->guruh_id, 'teach_id'=>$request->teacher_id]);
    }
    ...
    public function showGroupMark($task_id, $fan_id, $group_id, $teach_id){
        ...
        $fan = Fan::find($fan_id);
        return view('kafedraboshligi.layouts.mark.markgroup', compact('data', 'kursant', 'fan_id', 'teach_id', 'group_id', 'task', 'fan'));
    }
    public function marking($task_id, $fan_id,$guruh_id, $teach_id){
        ...
        $task = Task::find($task_id);
        return view('kafedraboshligi.layouts.mark.baholash',compact('kursantlar', 'fan', 'teacher', 'guruh_id', 'task'));
    }
