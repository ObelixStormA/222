...
class TaskController extends Controller
{
    ...
    public function beforeindex()
    {
        ...
        return view('kafedraboshligi.layouts.task.index', compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('kafedraboshligi.layouts.task.create', compact('fanlar', 'guruhlar'));
    }
...
//        dd($request->file('task')->getClientOriginalName());
        ...
        return redirect(route('kafedraboshligi.task.index'))->with('success', 'Yangi topshiriq yaratildi');
    ...
    public function show($task)
    {
        ...
        $fan = Fan::find($task);
        return view('kafedraboshligi.layouts.task.taskindex', compact('data', 'fan'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        $fanlar = FanBiriktirish::with('getFan')->select('fan_id')->where('teacher_id', $teach_id)->distinct()->get();
        $guruhlar = FanBiriktirish::with('getGuruh')->select('guruh_id')->where('teacher_id', $teach_id)->distinct()->get();
        return view('kafedraboshligi.layouts.task.edit', compact('task', 'fanlar', 'guruhlar'));
    }
...
//        dd($request->file('task')->getClientOriginalName());
        ...
        return redirect(route('kafedraboshligi.task.index'))->with('success', 'O\'zgertirildi');
    }
    ...
    public function destroy(Task $task)
    {
        ...
        return redirect(route('kafedraboshligi.task.index'))->with('success', 'O\'chirildi');
    }
}
