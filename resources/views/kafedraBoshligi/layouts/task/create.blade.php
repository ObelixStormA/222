        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 mt-4">
                ...
                <div class="card">
                    ...
                    @endif
                    <div class="card-body">
                        <form method="POST" action="{{route('kafedraboshligi.task.store')}}" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="text" name="task_nomi" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-6">
                                        <select name="fan_id" id="fan" class="form-control">
                                            @foreach($fanlar as $fan)
                                                <option value="{{$fan->fan_id}}">{{$fan->getFan->nomi}}</option>
                                            @endforeach
                                    ...
                                    <div class="col-6">
                                        <select name="guruh_id" id="fan" class="form-control">
                                            @foreach($guruhlar as $guruh)
                                                <option value="{{$guruh->guruh_id}}">{{$guruh->getGuruh->nomi}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="container mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <textarea type="text" name="desc" class="form-control" cols="86" rows ="5" placeholder="Topshiriq haqida qisacha ma'lumot"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="datetime-local" name="dead_line" class="form-control-sm" required>
                                    </div>
                                </div>
                            </div>
